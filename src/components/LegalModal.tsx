  ...
  return (
    <>
      ...
      <section className="space-y-2">
        <h4 className="text-sm font-semibold text-slate-900">Information we collect</h4>
        <ul className="list-disc pl-5 space-y-1.5 text-slate-600">
          <li>
            <span className="text-slate-800">Account data</span> — When you sign in with
            Google, we receive your Google account identifier, name, email address, and
            profile photo (if available).
          </li>
          <li>
            <span className="text-slate-800">Meeting content</span> — Audio you record or
          ...
          <li>
            <span className="text-slate-800">Billing data</span> — Purchase records for
          ...
          <li>
            <span className="text-slate-800">Usage data</span> — Credit balances and basic
      ...
      <section className="space-y-2">
        <h4 className="text-sm font-semibold text-slate-900">How we use information</h4>
        <ul className="list-disc pl-5 space-y-1.5 text-slate-600">
      ...
      <section className="space-y-2">
        <h4 className="text-sm font-semibold text-slate-900">Third-party services</h4>
        <p className="text-slate-600 leading-relaxed">
      ...
      <section className="space-y-2">
        <h4 className="text-sm font-semibold text-slate-900">What we do not do</h4>
        <ul className="list-disc pl-5 space-y-1.5 text-slate-600">
      ...
      <section className="space-y-2">
        <h4 className="text-sm font-semibold text-slate-900">Retention &amp; deletion</h4>
        <p className="text-slate-600 leading-relaxed">
...
function TermsContent() {
  return (
    <>
      ...
      <section className="space-y-2">
        <h4 className="text-sm font-semibold text-slate-900">The Service</h4>
        <p className="text-slate-600 leading-relaxed">
      ...
      <section className="space-y-2">
        <h4 className="text-sm font-semibold text-slate-900">Credits &amp; payments</h4>
        <ul className="list-disc pl-5 space-y-1.5 text-slate-600">
          <li>
      ...
      <section className="space-y-2">
        <h4 className="text-sm font-semibold text-slate-900">Acceptable use</h4>
        <p className="text-slate-600 leading-relaxed">
      ...
      <section className="space-y-2">
        <h4 className="text-sm font-semibold text-slate-900">AI output disclaimer</h4>
        <p className="text-slate-600 leading-relaxed">
          This AI-powered tool is provided solely for entertainment and creative purposes and
          is not guaranteed to be accurate. For critical needs, please consult professional
          translators. Transcripts and minutes may contain errors, omissions, or inaccurate
          speaker attribution. You are responsible for reviewing outputs before relying on
          them for business, legal, or compliance decisions.
        </p>
      </section>

      <section className="space-y-2">
        <h4 className="text-sm font-semibold text-slate-900">Intellectual property</h4>
        <p className="text-slate-600 leading-relaxed">
      ...
      <section className="space-y-2">
        <h4 className="text-sm font-semibold text-slate-900">Limitation of liability</h4>
        <p className="text-slate-600 leading-relaxed">
...
export function LegalModal({ type, onClose }: LegalModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-[fadeIn_0.2s_ease]">
      <div
        className="bg-white border border-slate-200 rounded-2xl max-w-lg w-full max-h-[85vh] overflow-hidden shadow-xl relative flex flex-col"
        role="dialog"
        aria-modal="true"
        aria-labelledby="legal-modal-title"
      >
        <div className="p-6 sm:p-8 pb-4 border-b border-slate-200 shrink-0 relative">
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="px-6 sm:px-8 py-5 overflow-y-auto space-y-5 text-sm flex-1 text-slate-600 [&_h4]:text-slate-900 [&_span]:text-slate-800">
          {isPrivacy ? <PrivacyContent /> : <TermsContent />}
        </div>

        <div className="p-6 sm:p-8 pt-4 border-t border-slate-200 shrink-0">
          <button
            type="button"
            onClick={onClose}
  ...
  return (
    <p className={`text-xs text-slate-500 ${className}`}>
      <button
        ...
        className="text-slate-500 hover:text-blue-600 underline underline-offset-2 cursor-pointer transition-colors"
      >
        Privacy Policy
      </button>
